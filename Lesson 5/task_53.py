...
def everything_for_your_cat(cats_data):
    ...
    for i in cats_data:
        new_cat = ""
        if i[2]+" "+i[3] in cats_dict:
            new_cat = cats_dict[i[2]+" "+i[3]] + "; " + i[0]+", "+str(i[1])
            cats_dict[i[2]+" "+i[3]] = new_cat
        else:
            cats_dict.setdefault(i[2]+" "+i[3], i[0]+", "+str(i[1]))
    for i in cats_dict:
        our_str += i + ": " + cats_dict[i] + "\n"
