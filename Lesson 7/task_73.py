...
class PublicTransport:
    def __init__(self, brand, power, year, color, max_speed):
        # обязательные атрибуты класса
        self.brand = brand
        self._engine_power = power
        self.year = year
        self.color = color
...
class Bus(PublicTransport):
    def __init__(self, brand, power, year, color, max_speed, passengers, park, fare):
        super().__init__(brand, power, year, color, max_speed)
        # обязательные атрибуты класса
...
class Tram(PublicTransport):
    def __init__(self, brand, power, year, color, max_speed, route, path, fare):
        super().__init__(brand, power, year, color, max_speed)
        # обязательные атрибуты класса
        self.__route = route
        self.path = path
